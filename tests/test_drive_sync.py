...
def build_service():
    ...
    service = DriveSyncService(
        ...
        registry=registry,
        drive=drive,
        doc_ingestor=lambda file_id: ingested.append(("doc", file_id)),
        sheet_ingestor=lambda file_id: ingested.append(("sheet", file_id)),
...
def test_connect_folder_rolls_back_new_registration_when_ingestion_fails():
    ...
    service = DriveSyncService(
        ...
        registry=registry,
        drive=drive,
        doc_ingestor=lambda file_id: (_ for _ in ()).throw(
            RuntimeError("embedding unavailable")
        ),
        sheet_ingestor=lambda file_id: None,
